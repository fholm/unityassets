...
public class CreatePlane : ScriptableWizard
{
    ...
    void OnWizardCreate()
    {
        ...
        Mesh m = (Mesh)AssetDatabase.LoadAssetAtPath("Assets/FpsHud/Meshes/" + planeAssetName, typeof(Mesh));
        ...
        if (m == null)
        {
            ...
            AssetDatabase.CreateAsset(m, "Assets/FpsHud/Meshes/" + planeAssetName);
